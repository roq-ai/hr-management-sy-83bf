...
export function EmployeeListPage(props: EmployeeListPageProps) {
    ...
    async () =>
      getEmployees({
        relations: [
          ...
          'organization',
          'payroll.count',
          'performance_evaluation_performance_evaluation_employee_idToemployee.count',
          'performance_evaluation_performance_evaluation_evaluator_idToemployee.count',
          'vacation.count',
        ],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('performance_evaluation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'performance_evaluation_performance_evaluation_employee_idToemployee',
          header: 'Performance Evaluation Performance Evaluation Employee Id Toemployee',
          accessorKey: 'performance_evaluation_performance_evaluation_employee_idToemployee',
          cell: ({ row: { original: record } }: any) =>
            record?._count?.performance_evaluation_performance_evaluation_employee_idToemployee,
        }
      : null,
    hasAccess('performance_evaluation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'performance_evaluation_performance_evaluation_evaluator_idToemployee',
          header: 'Performance Evaluation Performance Evaluation Evaluator Id Toemployee',
          accessorKey: 'performance_evaluation_performance_evaluation_evaluator_idToemployee',
          cell: ({ row: { original: record } }: any) =>
            record?._count?.performance_evaluation_performance_evaluation_evaluator_idToemployee,
        }
      : null,
